...
| [local-development-setup.md](local-development-setup.md) | 環境構築・Sample の起動・iOS 実機へ Sample を配備・計測するとき・MAUI Sample へ native の変更を配備して確認するとき・Sample でダーク描画を確認するとき・本体のビルド / lint・消費者検証 (`verification/`) の手元実行・本体 source へのステップインが要るとき | guide |
