...
- [api/maui-styling.md](api/maui-styling.md) — native の Theme / CellStyle / style 切替の MAUI 表現 (個別プロパティへの展開・未設定の色と外観・両外観の色を AppThemeBinding で決める手段・ListStyle・Section 装飾 4 属性・プロパティ一覧)
