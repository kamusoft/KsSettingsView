...
- [architecture/binding-build-integration.md](architecture/binding-build-integration.md) — MAUI binding が iOS xcframework と Android aar を生成・取り込みする構成、既知の制約、SDK 更新時の再検証箇所、NuGet 3 パッケージの pack 構成 (共通設定の置き場・最低 OS 版ガード・受け入れた SDK 挙動)
