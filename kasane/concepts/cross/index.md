...
- [architecture/release-pipeline.md](architecture/release-pipeline.md) — 3 platform を 1 本の release workflow で公開する段の構成、publish 段の内部順序、version の注入経路、各チャネルへの publish 機構、Release ノートの出所、待ちの時間予算、公開確認の手段
