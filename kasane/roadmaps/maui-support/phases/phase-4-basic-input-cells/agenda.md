...
- [x] (論点8決定 2026-08-10) sample-parity 規約 (kasane/handbook/cross/sample-parity.md) へ「デモ対象の公開 API が存在する platform に限る」例外条項を追加する — 蒸留時に実施済み (2026-08-11)
