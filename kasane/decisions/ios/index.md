...
| [0006](0006-swiftui-wrapper-ignores-container-safe-area.md) | SwiftUI ラッパは既定で container のセーフエリアを無視して全面に広がり、inset は UIKit に任せる | proposed | Representable の配置縮小が帯と iOS 26 大タイトル不全の原因。container 全辺を既定で無視し keyboard 領域は残す、opt-out の口を設ける。 |
